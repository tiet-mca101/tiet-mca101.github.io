...
\label{sec:org4807096}

\subsection{Straight Lines}
\label{sec:org65e9c83}

\begin{frame}[label={sec:org712ab30}]{\(y = mx + c\)}
\begin{align}
  \notag
  y = f(x) &= mx + c
\end{align}
...
\begin{frame}[label={sec:org98e7034}]{parametric form}
\begin{columns}
...
\begin{frame}[label={sec:orge5066d5}]{parametric form}
\begin{columns}
\begin{column}{.5\columnwidth}
...
\begin{frame}[label={sec:orga4c8abd}]{hesse normal form}
\begin{columns}
\begin{column}{.5\columnwidth}
\begin{center}
...
\subsection{Conics}
\label{sec:org60553c0}


\begin{frame}[label={sec:orge0987d0}]{circle}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8d094d6}]{ellipse}
\begin{columns}
\begin{column}{.4\columnwidth}
\begin{figure}[htbp]
\centering
...
\label{sec:orge2e0921}

\subsection{Fundamentals}
\label{sec:org3608076}

\begin{frame}[label={sec:org7970a81}]{problem}
\begin{columns}
\begin{column}{.5\columnwidth}
...
\begin{frame}[label={sec:org67c524b}]{method}
\begin{columns}
\begin{column}{.5\columnwidth}
...
\begin{frame}[label={sec:orgf9008ad}]{example}
\begin{center}
\includegraphics[width=0.8\linewidth]{images/basic-midpoint-algo.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org100674d}]{example}
\begin{center}
\includegraphics[width=\linewidth]{images/0--mid-point-algo_annotated.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org66e9fe5}]{conditions for application of mid-point algorithm}
\begin{columns}
...
\begin{frame}[label={sec:orgce7f497}]{generic algo}
\begin{algorithm}[H]
...
\label{sec:org7ca7708}

\begin{frame}[label={sec:orgf59d129}]{characterising straight lines}
\begin{align*}
  F(x,y)
  &= Ax-By+C \\
...
\begin{frame}[label={sec:org602f434}]{mid-point algo for st. line}
Case 1. \(\alert{0<A<B}\)
...
\begin{frame}[label={sec:orgbbd9852}]{mid-point algo for st. line}
Case 1. \(\alert{0<A<B}\)
...
\begin{frame}[label={sec:orgfcd7bb9}]{mid-point algo for st. line}
Case 1. \(\alert{0<A<B}\)
...
\begin{frame}[label={sec:org5e893fb}]{mid-point algo for st. line}
...
\begin{frame}[label={sec:org2674dac}]{mid-point algo for st. line}
...
\begin{frame}[label={sec:org1f9286d}]{mid-point algo for st. line}
...
\begin{frame}[label={sec:org9801dc8}]{exercise 1}
\begin{columns}
\begin{column}{.5\columnwidth}
...
\begin{frame}[label={sec:org1227cfa}]{solution 1 step 1}
...
\begin{frame}[label={sec:orgd314234}]{solution 1 step 2}
...
\begin{frame}[label={sec:orgb5e7af3}]{exercise 2 (practical)}
\begin{columns}
\begin{column}{.5\columnwidth}
\begin{enumerate}
