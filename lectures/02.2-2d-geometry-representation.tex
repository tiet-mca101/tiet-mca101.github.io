...
\label{sec:org34b9b34}

\subsection{Straight Lines}
\label{sec:orged05035}

\begin{frame}[label={sec:org733d65e}]{\(y = mx + c\)}
\begin{align}
  \notag
  y = f(x) &= mx + c
\end{align}
...
\begin{frame}[label={sec:org8ab677f}]{parametric form}
\begin{columns}
...
\begin{frame}[label={sec:orgd730408}]{parametric form}
\begin{columns}
\begin{column}{.5\columnwidth}
...
\begin{frame}[label={sec:org307fedb}]{hesse normal form}
\begin{columns}
\begin{column}{.5\columnwidth}
\begin{center}
...
\subsection{Conics}
\label{sec:org834d516}


\begin{frame}[label={sec:orgda982ff}]{circle}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgec961cc}]{ellipse}
\begin{columns}
\begin{column}{.4\columnwidth}
\begin{figure}[htbp]
\centering
...
\label{sec:orge752ead}

\subsection{Fundamentals}
\label{sec:orgc447b4b}

\begin{frame}[label={sec:org9f8f923}]{problem}
\begin{columns}
\begin{column}{.5\columnwidth}
...
\begin{frame}[label={sec:org9c03efe}]{method}
\begin{columns}
\begin{column}{.5\columnwidth}
...
\begin{frame}[label={sec:org60caff8}]{example}
\begin{center}
\includegraphics[width=0.8\linewidth]{images/basic-midpoint-algo.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:orge712280}]{example}
\begin{center}
\includegraphics[width=\linewidth]{images/0--mid-point-algo_annotated.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org2e1c10c}]{conditions for application of mid-point algorithm}
\begin{columns}
...
\begin{frame}[label={sec:orgc442c3c}]{generic algo}
\begin{algorithm}[H]
...
\label{sec:org1dcff0e}

\begin{frame}[label={sec:org5c9f386}]{characterising straight lines}
\begin{align*}
  F(x,y)
  &= Ax-By+C \\
...
\begin{frame}[label={sec:org29b9bf6}]{mid-point algo for st. line}
Case 1. \(\alert{0<A<B}\)
...
\begin{frame}[label={sec:orgf71d0e7}]{mid-point algo for st. line}
Case 1. \(\alert{0<A<B}\)
...
\begin{frame}[label={sec:orgc57e432}]{mid-point algo for st. line}
Case 1. \(\alert{0<A<B}\)
...
\begin{frame}[label={sec:org663e5c8}]{mid-point algo for st. line}
...
\begin{frame}[label={sec:org3646a87}]{mid-point algo for st. line}
...
\begin{frame}[label={sec:org742139a}]{mid-point algo for st. line}
...
\begin{frame}[label={sec:org66ddb30}]{exercise 1}
\begin{columns}
\begin{column}{.5\columnwidth}
...
\begin{frame}[label={sec:org7fc7ff2}]{solution 1 step 1}
...
\begin{frame}[label={sec:orgc464844}]{solution 1 step 2}
...
\begin{frame}[label={sec:orgd6ce15b}]{exercise 2 (practical)}
\begin{columns}
\begin{column}{.5\columnwidth}
\begin{enumerate}
