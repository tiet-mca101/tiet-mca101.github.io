...
\label{sec:org2d81992}

\begin{frame}[label={sec:org0fff22c}]{what are colours}
\begin{columns}
...
\begin{frame}[label={sec:org49adc62}]{rgb colours}
\begin{columns}
\begin{column}{.5\columnwidth}
\begin{quote}
...
\begin{frame}[label={sec:orgf2b6bd6}]{visible spectrum}
\begin{figure}[htbp]
\centering
...
\begin{frame}[label={sec:org9c9872a}]{rgb/a representation}
...
\label{sec:orga2d0da8}

\begin{frame}[label={sec:orgcef61b6}]{an image as composition of pixels}
\begin{columns}
...
\begin{frame}[label={sec:orgf7ddfd4}]{an image as a bounded space}
\begin{columns}
\begin{column}{.67\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org7796ac1}]{image channels}
\begin{columns}
\begin{column}{.67\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org17d7804}]{image in floating-point representation}
\begin{columns}
\begin{column}{.67\columnwidth}
...
\begin{frame}[label={sec:orgece9a86}]{image in 8-bit fixed-point}
\begin{columns}
\begin{column}{.67\columnwidth}
...
\begin{frame}[label={sec:org4487b3b}]{question}
\begin{enumerate}
...
\begin{frame}[label={sec:org306d285}]{question}
\begin{enumerate}
...
\label{sec:org926c0c8}

\begin{frame}[label={sec:org461a496}]{colour tables}
\begin{columns}
\begin{column}{.67\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org4e24197}]{storage efficiency}
\begin{columns}
\begin{column}{.67\columnwidth}
For example,
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org9ffb8c9}]{storage efficiency}
\begin{columns}
\begin{column}{.67\columnwidth}
\begin{center}
\begin{tabular}{rr}
...
\begin{frame}[label={sec:orgf268ed3}]{question}
\begin{columns}
\begin{column}{.67\columnwidth}
...
\label{sec:org6df1653}

\begin{frame}[label={sec:orgc5cc1c1}]{hsl and hsv}
\begin{columns}
